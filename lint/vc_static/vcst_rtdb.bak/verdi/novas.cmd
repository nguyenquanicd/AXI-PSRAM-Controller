...
return 1;
verdiWindowResize -win $_Verdi_1 "304" "233" "1100" "800"
verdiWindowResize -win $_Verdi_1 "304" "233" "1100" "800"
verdiSetActWin -dock widgetDock_MTB_SOURCE_TAB_1
srcSetPreference -vhdlcase original
schUnifiedNetList
schSetPreference -FixViewOnTraceStartingInst on
verdiRunVcst -on
schSetOptions -win $_nSchema1 -hierFlatten on
schSetVCSTDelimiter -hierDelim "/"
...
simSetSimulator "-vcssv" -exec \
           "/home/ltthinh/PSRAM_CTRL/lint/vc_static/vcst_rtdb/.internal/design/m_vlsi_qspi_top.exe" \
           -args
debImport "-simflow" "-smart_load_kdb" "-dbdir" \
          "/home/ltthinh/PSRAM_CTRL/lint/vc_static/vcst_rtdb/.internal/design/m_vlsi_qspi_top.exe.daidir"
srcSetDecoration -reset
srcSetDecoration -inst "1"
schResetDisplayAttr -white
opVerdiComponents -xmlfile \
           "/home/ltthinh/PSRAM_CTRL/lint/vc_static/vcst_rtdb/.internal/verdi/signalnames.xml"
